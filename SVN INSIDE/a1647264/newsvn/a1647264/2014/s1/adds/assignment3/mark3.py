...
# prac3
Input = [ 'Avalanche Bureaucrat Bureaucrat Toolbox Toolbox Crescendo Crescendo FistfullODollars',
          ...
          'Avalanche Toolbox Bureaucrat Toolbox Avalanche Avalanche Avalanche Avalanche'
        ]
Output = [ 'Toolbox', 
          'Avalanche',
          'Bureaucrat',
