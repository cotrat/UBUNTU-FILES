...
/* A quite simple glass in general which requires little comments, as all functions are very basic mutators or accessors and 
	their purpose can easily be identified from their name */
