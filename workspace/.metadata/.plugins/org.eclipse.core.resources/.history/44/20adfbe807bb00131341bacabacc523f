...
public abstract class Vehicle extends Entity {
	...
	//ADDED BY MITCHELL ANDERSON
		public int Occupancy() // THIS FUNCTION RETURNS THE 'OCCUPANCY' OF A VEHICLE, ONLY NEEDED FOR TAXIS
		{
			return occupants;
		}
	
		public void SetOccupancy() // THIS FUNCTION SETS THE OCCUPANCY OF A VEHICLE USING THE RAND FUNCTION FOUND IN UTILS
		{
