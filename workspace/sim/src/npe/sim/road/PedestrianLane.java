...
public class PedestrianLane extends Lane {
	...
	/** MITCH'S ARRAY LIST OF STORING A 'QUEUE' OF PEDESTRIANS WAITING FOR A TAXI **/
	private ArrayList<Pedestrian> pedWaiting;
	...
	public PedestrianLane(Road road, double x, double y, double direction)
	{
		...
		pedWaiting = new ArrayList<Pedestrian>(10);
		...
		stoppingArea2 = new Rectangle2D.Double(0, 0, 0, 0); // Initialised to an area of 0x0 
